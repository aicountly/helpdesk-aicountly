...
Helpdesk for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://helpdesk.aicountly.com | https://helpdesk.aicountly.com/api |
| Sandbox | https://helpdesk.gh.aicountly.com | https://helpdesk.gh.aicountly.com/api |
...
(`https://helpdesk.gh.aicountly.com/api`) so the token exchange has somewhere to
