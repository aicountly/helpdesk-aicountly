...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Helpdesk').trim() || 'Helpdesk'
 ...
 * with the app on both helpdesk.aicountly.com and helpdesk.gh.aicountly.com. That
