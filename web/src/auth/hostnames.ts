 ...
 * helpdesk.aicountly.com and helpdesk.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'helpdesk').trim() || 'helpdesk'
...
/**
 * `helpdesk.aicountly.com` and `helpdesk.gh.aicountly.com` both resolve to
 * `helpdesk`, which is what the portal expects in authentication_jump.
 */
